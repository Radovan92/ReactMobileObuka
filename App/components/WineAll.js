    ...
    render() {
        return (
            ...
            <View
                    ...
                    <View>
                        <Text style={{fontSize: 19, padding: 10, color: '#fff'}}>WineAll.js</Text>
                    </View>              
                            ...
                            />
        <ActionButton buttonColor="pink">
          <ActionButton.Item buttonColor='#841584' title="Dodaj Novo Vino" onPress={this.goToNewWine.bind(this)}>
